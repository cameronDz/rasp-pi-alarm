...
/**
 * SecuritySystem class in the state design pattern representing the context of
 * the security system.
 * 
 * @author Tom
 */
public class SecuritySystem {
	 ...
	 * 
	 * @param takes
	 *            interface for armed/disarmed state
	 */
	void setDetectorState(DetectorState newDetectorState) {
		if (newDetectorState != null) {
			detectorState = newDetectorState;
		} else {
			System.out.println("Can not set null detectorState.");
		}
	}
	...
	public String toString() {
		return "SecuritySystem [detectorState=" + detectorState + ", armed=" + armed + ", disarmed=" + disarmed + "]";
	}
}
