...
/**
 * Class representing a disarmed security system state in the state design
 * pattern
 * 
 * @author Tom
 */
public class DisarmedState implements DetectorState {
	...
	/**
	 * Method to arm a disarmed state in the security system. Sets the security
	 * system to an armed state, calls the adapter method Arm() which activates the
	 * ultrasonic sensor through the python script.
	 * 
	 * @param notifier
